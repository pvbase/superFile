...
import GoodsData from "./programPlan.json";
import axios from 'axios';
import moment from 'moment';
class programPlan extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    getTableData = () => {
        ...
        axios({
            method: 'get',
            url: `https://apidev.zenqore.com/edu/master/programPlan?orgId=${this.state.orgId}&page=${this.state.page}&limit=${this.state.limit}`,
            headers: {
