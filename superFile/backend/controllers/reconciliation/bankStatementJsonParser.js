 ...
 */
async function parseDataMapJson(bankStmtFilePath) {
    const dbConnection = await createConnection(dbName, mongoDbUrl);
    // console.log(dbConnection); 

    let bankStmt = null;
    try {
        const jsonString = fs.readFileSync(bankStmtFilePath);
        bankStmt = JSON.parse(jsonString);
    } catch (err) {
        console.log(err)
    }
...
async function parseJsons() {
    // parseDataMapJson("../../../reconDataMapJsons/zq_data_IB_STMT.json");
    // parseDataMapJson("../../../reconDataMapJsons/zq_data_HDFC_STMT.json");
    // parseDataMapJson("../../../reconDataMapJsons/zq_data_AXIS_STMT.json");
    // parseDataMapJson("../../../reconDataMapJsons/zq_data_BOB_STMT.json");
    // parseDataMapJson("../../../reconDataMapJsons/zq_data_CANARA_STMT.json");
    // parseDataMapJson("../../../reconDataMapJsons/zq_data_DBS_STMT.json");
    // parseDataMapJson("../../../reconDataMapJsons/zq_data_ICICI_STMT.json");
    // parseDataMapJson("../../../reconDataMapJsons/zq_data_CITI_STMT.json");
    // parseDataMapJson("../../../reconDataMapJsons/zq_data_SBI_STMT.json");
    // parseDataMapJson("../../../reconDataMapJsons/zq_data_YESBANK_STMT_Apr2020.json");
    // parseDataMapJson("../../../reconDataMapJsons/zq_data_YESBANK_STMT_May2020.json");
    // parseDataMapJson("../../../reconDataMapJsons/zq_data_YESBANK_STMT_Jun2020.json");
    // parseDataMapJson("../../../reconDataMapJsons/zq_data_JKBANK_STMT.json");
    parseDataMapJson("../../../reconDataMapJsons/zq_data_JKBANK_mock_2.json");
} // parseJsons
