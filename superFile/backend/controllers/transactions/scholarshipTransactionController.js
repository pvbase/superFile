/**
 * @author muniyaraj.neelemagam@zenqore.com
 */
 ...
 * @param {*} res
 */
async function processTransactionScholarship(req, dbConnection) {
...
async function insertFeesDueLedgerEntries(
  ...
  let feesLedgerData = {
    ...
    feeTypeCode: txnData.data.feeTypeCode,
...
function checkFeesBreakUpTotal(txnData) {
  ...
  for (feeItem of txnData.data.feesBreakUp) {
    ...
    if (!amount || amount == null) {
      errMsg =
        "scholarshipTransactionController: amount not found in feesBreakUp";
  ...
  //   errMsg =
  //     "scholarshipTransactionController: total of feesBreakUp " +
  //     total +
...
module.exports = {
  processTransactionScholarship: processTransactionScholarship,
