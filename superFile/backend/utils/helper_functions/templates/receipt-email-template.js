...
const receiptTemplate = (orgDetails, transaction) => {
  return `
...
<p>Regards,</p>
<p><strong>${transaction.campus.name} Accounts Team</strong></p>
<p>&nbsp;</p>`;
};
...
const receiptPdf = async (
  ...
  if (!qrCode) {
    if (type == "receipt") {
        ...
        ​
            <div class="container">
                ...
                padding-left: 25px;font-size:12px">
                    <h3 style="margin: 0;
                    padding: 0;">${demandNoteDetails[0].campus.name}</h3>
                    <p style=" line-height: 1.5;margin: 0;
                    padding: 0;">${demandNoteDetails[0].campus.address1}${
        demandNoteDetails[0].campus.address2
      }${demandNoteDetails[0].campus.address3}</p>
      <p style=" line-height: 1.5; font-family: sans-serif;margin: 0; padding: 0;">${
        ...
        ​
            <div style="font-size: 12px; font-family: sans-serif; margin-top: 5px;">
        ...
        ​
            ...
            font-family: sans-serif;">
                <tr>
                    ...
                    border-collapse: collapse;
                    font-size: 12px;
                    font-family: sans-serif;padding: 10px;">Registration ID</td>
  ...
  <p style=" line-height: 1.5; font-family: sans-serif;margin: 0; padding: 0;">${
    demandNoteDetails[0].campus.city
        ...
        ​
            <p class="signature" style="text-align: center;
            margin: 0px;font-size:10px;margin-bottom:0px">This is a computer generated fee acknowledgement and does not require any signature</p>
        </body>
        ​
        </html>`;
    }
...
<p style=" line-height: 1.5; font-family: sans-serif;margin: 0; padding: 0;">${
    ...
    <p style="text-align:center">Please scan the QR code to access this receipt from our portal<p></td></tr>
      ...
      ​
          <p class="signature" style="text-align: center;
          margin: 0px;font-size:10px;margin-bottom:0px">This is a computer generated fee acknowledgment and does not require any signature</p>
      </body>
      ​
      </html>`;
    }
...
module.exports = { receiptTemplate, receiptPdf };
